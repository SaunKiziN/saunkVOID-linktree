            ...
            audio.play().then({
                "AudioProvider.useCallback[startBackgroundMusic]": ()=>{
                    ...
                    const interval = setInterval({
                        "AudioProvider.useCallback[startBackgroundMusic].interval": ()=>{
                    ...
                    }["AudioProvider.useCallback[startBackgroundMusic].interval"], 200);
                }
                ...
                "AudioProvider.useCallback[toggleMusic]": (prev)=>{
                    ...
                    if (audio) {
                        if (!next) {
                            ...
                            audio.play().catch({
                                "AudioProvider.useCallback[toggleMusic]": ()=>{
                                // se der erro, próximo clique ajeita
                                }
                            }["AudioProvider.useCallback[toggleMusic]"]);
                        }
                    }
...
_s(AudioProvider, "9fb6FhSDU0p23jQmKtlYBoQgCI4=");
_c = AudioProvider;
function useAudio() {
    _s1();
...
//# sourceMappingURL=OneDrive_%C3%81rea%20de%20Trabalho_linktree-website-design_836ed667._.js.map